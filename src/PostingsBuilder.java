...
public class PostingsBuilder {
    ...
    /**
     * Removes all the postings associated with the term
     * @param term
     */
    public void remove(String term) throws IRException{
        if (!postings.containsKey(term)){
            throw new IRException("Attempting to remove a term that does not exist in postings");
        }
